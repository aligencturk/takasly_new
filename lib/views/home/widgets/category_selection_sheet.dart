...
class _CategorySelectionSheetState extends State<CategorySelectionSheet> {
  // We'll manage a local navigation stack manually if needed,
  // but since the HomeViewModel already has logic for subcategories,
  // we can leverage that.
  // However, for a user-friendly UI, we might want to see the path they took.
                    ...
                    if (vm.selectedCategory != null)
                      Padding(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            // Logic to go back up one level would be ideal
                            // But currently VM only supports setSelectedCategory(null) effectively resetting to root
                            // To keep it simple as per VM logic:
