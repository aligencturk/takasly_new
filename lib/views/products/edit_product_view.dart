...
import '../../models/products/product_models.dart' show Category, Product;
...
class _EditProductViewBody extends HookWidget {
  ...
  Future<void> _handleSubmission(
    ...
    if (token != null && userId != null) {
      ...
      // If token/userId missing, likely session expired
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
      ...
      child: Column(
        ...
        children: [
          _SectionHeader(
            ...
            subtitle:
                'İlan başlığını ve kategorisini buradan güncelleyebilirsiniz.',
          ),
          const SizedBox(height: 32),
          _CustomTextField(
            controller: viewModel.titleController,
            label: 'İlan Başlığı',
            hint: 'İlan başlığı giriniz',
      ...
      child: Column(
        ...
        children: [
          _SectionHeader(
            ...
            subtitle: 'Ürünün mevcut durumunu buradan güncelleyebilirsiniz.',
          ),
          const SizedBox(height: 24),
          ...
          _SectionHeader(
            ...
            subtitle:
                'Bu ürün karşılığında ilginizi çekebilecek şeyleri düzenleyin.',
          ),
          const SizedBox(height: 24),
          _CustomTextField(
            controller: viewModel.tradeForController,
            label: 'Takas İsteği',
            hint: 'Örn: MacBook Air M2, PlaySation 5...',
            maxLines: 3,
      ...
      child: Column(
        ...
        children: [
          _SectionHeader(
            ...
            subtitle: 'Ürün açıklaması ve görsellerini güncelleyin.',
          ),
          const SizedBox(height: 24),
          ...
          _CustomTextField(
            ...
            hint: 'Ürün hakkında detaylı bilgi verin...',
            maxLines: 5,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _SectionHeader(
            title: 'Konum Bilgisi',
            subtitle: 'Ürünün güncel konum bilgisini seçin.',
          ),
          const SizedBox(height: 24),
          ...
          _SectionHeader(
            ...
            subtitle: 'İletişim tercihlerini düzenleyin.',
          ),
          const SizedBox(height: 16),
...
class _ImageGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final totalCount =
        viewModel.existingImages.length + viewModel.newImages.length;
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if (index < viewModel.existingImages.length) {
                  // Existing
                  ...
                  // New
                  int newIndex = index - viewModel.existingImages.length;
                  return _ImageThumbnail(
        ...
        children: [
          ...
          Expanded(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                isLastStep ? 'Bilgileri Güncelle' : 'Devam Et',
                style: const TextStyle(
                  color: Colors.white,
                  fontWeight: FontWeight.w800,
                  fontSize: 16,
